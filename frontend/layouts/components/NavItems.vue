<template>
  ...
  <template v-for="item in items">
    <VerticalNavSectionTitle v-if="item.hasOwnProperty('section')" :item="{heading: item.section}"/>
    <VerticalNavGroup v-else-if="item.hasOwnProperty('children')" :item="{title: item.title, icon:item.icon}">
      <VerticalNavLink
    ...
    <VerticalNavLink v-else :item="{title: item.title, icon: item.icon, to: item.to, href: item.href}"/>
  </template>
</template>
